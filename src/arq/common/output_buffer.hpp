#ifndef _ARQ_COMMON_OUTPUT_BUFFER_HPP_
#define _ARQ_COMMON_OUTPUT_BUFFER_HPP_

#include <optional>

#include "arq/common/rx_buffer_object.hpp"
...
private:
    ...
    arq::SequenceNumber nextSequenceNumber_ = FIRST_SEQUENCE_NUMBER;
};
